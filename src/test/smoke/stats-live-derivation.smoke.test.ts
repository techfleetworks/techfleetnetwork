// ADR-0045 guard — the read path for displayed stats must be LIVE-derived and must never
...
describe("Displayed stats are live-derived, not read from a stored counter (ADR-0045)", () => {
