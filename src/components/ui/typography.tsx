...
const HEADING_BASE =
  "tf-h font-display font-bold leading-[1.1] tracking-[0.012em] text-foreground";
const HEADING_MEDIUM =
  "tf-h font-display font-medium leading-[1.1] tracking-[0.012em] text-foreground";
const BODY_BASE = "tf-p font-sans leading-[1.5] tracking-[0.012em]";
...
>(({ className, ...props }, ref) => (
  <h1
    ref={ref}
    className={cn(HEADING_BASE, "leading-none break-words [overflow-wrap:anywhere] text-[clamp(1.875rem,4vw,3rem)]", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <h1
    ref={ref}
    className={cn(HEADING_BASE, "break-words [overflow-wrap:anywhere] text-[clamp(1.5rem,3vw,2.25rem)]", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <h2
    ref={ref}
    className={cn(HEADING_BASE, "break-words [overflow-wrap:anywhere] text-[clamp(1.25rem,2.25vw,1.75rem)]", className)}
    {...props}
  />
));
