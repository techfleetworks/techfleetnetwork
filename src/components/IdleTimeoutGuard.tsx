...
export function IdleTimeoutGuard() {
  ...
  const { resetTimers } = useIdleTimeout({
    timeoutMs: 60 * 60 * 1000,  // 1 hour idle timeout
    ...
    <AlertDialog open={showWarning} onOpenChange={setShowWarning}>
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            You've been inactive for 58 minutes. You'll be signed out in 2 minutes for security. Click below to stay signed in.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
