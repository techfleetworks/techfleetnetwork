...
| Cross-border transfer of personal data (Anthropic US; **DeepSeek → China**)    | Med        | High   | Residency assessment REQUIRED for DeepSeek + OpenRouter + DPA; document in the data classification (owner action)                                                                                           |
