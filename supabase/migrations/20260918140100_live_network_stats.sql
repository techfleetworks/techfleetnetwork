-- ADR-0046 — live-derived stats (EXPAND). get_network_stats() computes platform-owned
...
comp AS (
  ...
  -- out here too, exactly as they do on the course card (ADR-0046). lesson_catalog is the
