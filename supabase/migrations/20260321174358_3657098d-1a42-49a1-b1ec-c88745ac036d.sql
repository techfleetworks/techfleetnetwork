...
-- Update notify_project_opening to include preferences deep link in email footer
...
-- Update notify_feedback_submitted to include preferences deep link in email footer
